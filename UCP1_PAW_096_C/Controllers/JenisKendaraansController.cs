...
namespace UCP1_PAW_096_C.Controllers
{
    public class JenisKendaraansController : Controller
    {
        ...
        public JenisKendaraansController(JajanOnlineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJenisKendaraan,JenisKendaraan1")] JenisKendaraan jenisKendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdJenisKendaraan,JenisKendaraan1")] JenisKendaraan jenisKendaraan)
        {
